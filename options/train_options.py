...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--evaluation_freq', type=int, default=50, help='frequency to run the val code')
        parser.add_argument('--num_validation_samples', type=int, default=20, help='number of samples to evaluate the results on')
        ...
        parser.add_argument('--gan_mode', type=str, default='lsgan', help='the type of GAN objective. [vanilla| lsgan | wgan| wgan-gp]. vanilla GAN loss is the cross-entropy objective used in the original GAN paper.')
